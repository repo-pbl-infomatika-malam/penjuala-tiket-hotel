  ...
  <div class="container ">
    ...
    <table class="table table-bordered  table-hover container">
      ...
      <tr>
        ...
        <td class="d-flex gap-1">
          <a href="#"
            ...
            data-bs-toggle="modal"
            data-bs-target="#editData<?php echo $dataHotel['id_room']; ?>">Ubah</a>
          <a href="controller/hapuseData.php?idroom=<?php echo $dataHotel['id_room']; ?>"
            data-toggle="modal"
      ...
      <div class="modal fade modal-lg"
        id="editData<?php echo $dataHotel['id_room']; ?>"
          ...
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title fs-5"
                id="staticBackdropLabel">FORM DATA PRODUCT </h5>
              <button type="button"
                class="btn-close"
            ...
            <form method="POST"
              action="controller/ubahData.php"
              ...
              <div class="modal-body overflow-auto">
                ...
                <div class="mb-3">
                  ...
                  <input type="number"
                    ...
                    value="<?php echo $dataHotel['room_number']; ?>">
                </div>
                ...
                <div class="mb-3">
                  ...
                  <input type="text"
                    ...
                    name="nama_kamar"
                    placeholder="Masukan Nomor Kamar"
                    value="<?php echo $dataHotel['room_name']; ?>">
                </div>

                <div class="mb-3">
                  <label class="form-label">DESKRIPSI</label>
                  <input class="form-control"
                    value="<?php echo $dataHotel['description']; ?>"
                ...
                <div class="mb-3">
                  ...
                  <input type="text"
                    class="form-control"
                    value="<?php echo $dataHotel['price']; ?>"
                    name="harga_kamar"
    ...
    <div class="modal fade modal-lg"
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <form method="POST"
            action="controller/tambahData.php"
            enctype="multipart/form-data">
            <div class="modal-body overflow-auto">
              <div class="mb-3">
                <label class="form-label">NOMOR KAMAR</label>
